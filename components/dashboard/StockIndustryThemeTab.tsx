            ...
            <CardContent className="p-0">
                <Tabs defaultValue="industry" className="w-full">
                    ...
                    <TabsContent value="industry" className="mt-0">
                        {/* Card wrapper removed to avoid double padding/border as StockIndustryTab has its own card */}
                        <StockIndustryTab symbol={symbol} />
                    </TabsContent>

                    <TabsContent value="theme" className="mt-0">
                        {/* Card wrapper removed to avoid double padding/border as StockThemeTab has its own card */}
